...
const Login = () => {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: classes.root },
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: classes.loginContainer },
            ...
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("form", null,
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: classes.formGroup },
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement("input", { className: classes.input, type: "text", id: "username", name: "username", placeholder: "Email", required: true })),
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: classes.formGroup },
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement("input", { className: classes.input, type: "password", id: "password", name: "password", placeholder: "Password", required: true })),
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: classes.formGroup },
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement("button", { className: classes.button, type: "submit" }, "Login"))))));
};
//<GreetingComponent isTrue={isTrue} />
...
if (typeof window === 'undefined') {
    const dotenv = __webpack_require__(/*! dotenv */ "webpack/sharing/consume/default/dotenv/dotenv");
    dotenv.config();
}
const ACCESS_TOKEN = process.env.KEY;
...
/* harmony import */ var _src_icons_z_icon_svg__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../../../../../src/icons/z_icon.svg */ "./src/icons/z_icon.svg");
...
console.log(_config__WEBPACK_IMPORTED_MODULE_7__.ACCESS_TOKEN);
class ZenodoWidget extends _lumino_widgets__WEBPACK_IMPORTED_MODULE_2__.Widget {
    constructor(app) {
        ...
        const icon = new _jupyterlab_ui_components__WEBPACK_IMPORTED_MODULE_3__.LabIcon({
            ...
            svgstr: _src_icons_z_icon_svg__WEBPACK_IMPORTED_MODULE_8__,
        });
