...
## `API/API_functions.tsx` {#api_functions}
...
## `components/FileBrowser.tsx` {#filebrowser}
...
## `components/SearchPanel.tsx` {#searchpanel}
...
## `components/SideBarPanel.tsx` {#sidebar}
...
## `components/confirmation.tsx` {#confirmation}
